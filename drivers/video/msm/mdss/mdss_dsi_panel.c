...
DEFINE_MUTEX(LP_STOP_MODE_LOCK); /* For Hall ic panel reset funtion */
...
error:
	...
	/* Prevent : "remove error2 label" double_free: Calling kfree frees pointer buf which has already been freed. */
#endif
